...
app1 = Application.create!(name: "Andrew", address: "123 Main St", city: "Denver", state: "CO", zip: "80021")
app2 = Application.create!(name: "Khoa", address: "321 Broadway St", city: "Denver", state: "CO", zip: "80021")
